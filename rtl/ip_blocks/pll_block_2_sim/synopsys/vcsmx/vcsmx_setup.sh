...
# ACDS 20.1 711 win32 2023.09.01.12:46:01
...
# ----------------------------------------
# If pll_block_2 is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_block_2.vo"
fi
