...
# ACDS 18.1 625 win32 2021.01.18.11:17:39
...
# ----------------------------------------
# If ChipID is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ChipID.vhd"
fi
