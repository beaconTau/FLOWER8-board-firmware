//altasmi_parallel CBX_AUTO_BLACKBOX="ALL" CBX_SINGLE_OUTPUT_FILE="ON" DATA_WIDTH="STANDARD" DEVICE_FAMILY="Cyclone V" ENABLE_SIM="FALSE" EPCS_TYPE="EPCQ64" FLASH_RSTPIN="FALSE" PAGE_SIZE=256 PORT_BULK_ERASE="PORT_USED" PORT_DIE_ERASE="PORT_UNUSED" PORT_EN4B_ADDR="PORT_UNUSED" PORT_EX4B_ADDR="PORT_UNUSED" PORT_FAST_READ="PORT_UNUSED" PORT_ILLEGAL_ERASE="PORT_USED" PORT_ILLEGAL_WRITE="PORT_USED" PORT_RDID_OUT="PORT_UNUSED" PORT_READ_ADDRESS="PORT_USED" PORT_READ_DUMMYCLK="PORT_UNUSED" PORT_READ_RDID="PORT_UNUSED" PORT_READ_SID="PORT_UNUSED" PORT_READ_STATUS="PORT_UNUSED" PORT_SECTOR_ERASE="PORT_USED" PORT_SECTOR_PROTECT="PORT_UNUSED" PORT_SHIFT_BYTES="PORT_USED" PORT_WREN="PORT_USED" PORT_WRITE="PORT_USED" USE_ASMIBLOCK="OFF" USE_EAB="ON" WRITE_DUMMY_CLK=0 addr asmi_dataoe asmi_dataout asmi_dclk asmi_scein asmi_sdoin bulk_erase busy clkin data_valid datain dataout illegal_erase illegal_write rden read read_address reset sector_erase shift_bytes wren write INTENDED_DEVICE_FAMILY="Cyclone V" ALTERA_INTERNAL_OPTIONS=SUPPRESS_DA_RULE_INTERNAL=C106
...
//synthesis_resources = a_graycounter 4 lpm_compare 2 lpm_counter 3 lut 29 mux21 1 reg 130 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"SUPPRESS_DA_RULE_INTERNAL=C106"} *)
module  epcqio_block_asmi_parallel_0
	( 
	addr,
	asmi_dataoe,
	asmi_dataout,
...
`endif
	...
	always @ ( negedge clkin_wire or  posedge reset)
		...
		else  add_rollover_reg <= (wire_read_add_cntr_q[23] | clr_read_wire2);
	// synopsys translate_off
	initial
		addr_reg[0:0] = 0;
	// synopsys translate_on
	...
	always @ ( negedge clkin_wire or  posedge reset)
		...
		else  buf_empty_reg <= wire_cmpr4_aeb;
	// synopsys translate_off
	initial
		bulk_erase_reg = 0;
	// synopsys translate_on
	...
	always @ ( negedge clkin_wire or  posedge reset)
		...
		else  max_cnt_reg <= wire_cmpr3_aeb;
	// synopsys translate_off
	initial
		maxcnt_shift_reg = 0;
	// synopsys translate_on
	...
	assign
		wire_pgwrbuf_dataout_d = {(({7{read_bufdly}} & wire_scfifo2_q[7:1]) | ({7{(~ read_bufdly)}} & pgwrbuf_dataout[6:0])), (read_bufdly & wire_scfifo2_q[0])};
	assign
	...
	assign
		wire_read_add_reg_d = {wire_read_add_cntr_q[23:0]};
	assign
		wire_read_add_reg_ena = {24{((end_read_byte & end_one_cyc_pos) & (~ end_operation))}};
	// synopsys translate_off
	initial
		read_bufdly_reg = 0;
	// synopsys translate_on
	...
	defparam
		scfifo2.lpm_numwords = 258,
		scfifo2.lpm_width = 8,
		scfifo2.lpm_widthu = 9,
		scfifo2.use_eab = "ON",
		scfifo2.lpm_type = "scfifo";
	assign
		add_rollover = add_rollover_reg,
		addr_overdie = 1'b0,
		addr_overdie_pos = 1'b0,
		addr_reg_overdie = {24{1'b0}},
		asmi_dataoe = {dataoe_wire[3:0]},
		asmi_dclk = clkin_wire,
		asmi_scein = scein_wire,
		asmi_sdoin = {datain_wire[3:0]},
		...
		read_address = {read_add_reg[23:0]},
...
endmodule //epcqio_block_asmi_parallel_0
//VALID FILE
